...
public class Thermostat extends HttpServlet{
	...
	public Thermostat(String name, double price, String image, String retailer,String condition,double discount,String description,String warranty,String rebates){
		this.id=id;
		this.name=name;
		this.price=price;
		this.image=image;
